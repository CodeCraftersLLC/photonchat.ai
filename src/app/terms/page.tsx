  ...
  return (
    <div className='bg-white'>
      ...
      <main className='prose prose-indigo prose-a:text-indigo-600 mx-auto max-w-3xl px-6 py-10'>
        <h1 className='!mb-8 text-center text-3xl font-bold'>Terms &amp; Conditions for ProtonChat.ai</h1>
        ...
        <p>
          By downloading, installing, or using ProtonChat.ai (the &ldquo;App&rdquo;), these Terms &amp; Conditions (the
          &ldquo;Terms&rdquo;) will automatically apply to you. Please read them carefully before using the App.
        </p>

        <p>
          ProtonChat.ai is committed to ensuring that the App is as useful and efficient as possible. Therefore, we
        ...
        <p>
          ...
          features, and result in ProtonChat.ai malfunctioning or not working at all.
        </p>
        ...
        <p>
          ProtonChat.ai cannot always take responsibility for how you use the App. For example, it is your
          responsibility to ensure that your device remains charged. If your device runs out of battery and you cannot
          turn it on to use the Service, ProtonChat.ai cannot accept responsibility.
        </p>
        ...
        <p>
          ...
          information to us. ProtonChat.ai accepts no liability for any loss—direct or indirect—that you experience as a
        ...
        <p>
          ...
          change, and you will need to download the updates if you want to keep using the App. ProtonChat.ai does not
